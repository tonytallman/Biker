...
Evolution: stratified GATT access (`GATTPeripheral`, adapter, serialized decorator) is documented in [`0016-introduce-gatt-peripheral-layer.md`](0016-introduce-gatt-peripheral-layer.md); a later phase will move `Sensor` onto that layer and simplify duplication between sensor-layer and GATT-layer serialization.
